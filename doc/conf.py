...
project = u'django-fusionbox-blog'
...
htmlhelp_basename = 'django-fusionbox-blogdoc'
...
latex_documents = [
  ('index', 'django-fusionbox-blog.tex', u'django-fusionbox-blog Documentation',
   u'Fusionbox', 'manual'),
]
...
man_pages = [
    ('index', 'django-fusionbox-blog', u'django-fusionbox-blog Documentation',
     [u'Fusionbox'], 1)
]
import sys
import os
